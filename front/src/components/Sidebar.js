    ...
    <>
      ...
      <aside ref={sidebarRef} className={`sidebar ${getSidebarClass()}`}>
        ...
        <nav className="menu-list">
          ...
          <div className="menu-item" onClick={() => navigate('/liveness')}><VerifiedUser /> <span>{currentLang === "am" ? "የህይወት ማረጋገጫ" : "Life Verification"}</span></div>

          <div className="menu-item" onClick={() => navigate('/admin-dashboard')}><Assessment /> <span>{currentLang === "am" ? "ሪፖርቶች" : "Reports"}</span></div>
